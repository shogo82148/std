...
//
//   - format: "format"オプションはフィールド値のフォーマットを特化するための
//     フォーマットフラグを指定します。
//     オプションは "format:value" のキー・バリュー形式で、値は英数字からなるリテラル
//     （例："format:RFC3339"）または単一引用符で囲んだ文字列リテラル
//     （例："format:'2006-01-02'"）のいずれかでなければなりません。
//     フォーマットフラグの解釈は構造体フィールドの型によって決定されます。
//

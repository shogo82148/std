...
//
// 通常の型またはインスタンス化された型tでは、このメソッドのレシーバ基底型は
// 名前付き型tです。返されるFuncのSignatureはレシーバの型パラメータを
// 持ちません。
//
// インスタンス化されていないジェネリック型tでは、各メソッドのレシーバは
// そのレシーバ型パラメータでインスタンス化されます。返されるFuncのSignatureは
// レシーバをインスタンス化するために使われたレシーバ型パラメータを持ちます。
//

...
//
// [ChaCha8] ソースは、予測に強い汎用的なソースです。
// [PCG] ソースはより高速ですが、セキュリティに関わる用途には適していません。
//
// このパッケージの出力は、どのようにシードしたかに関係なく、
// 容易に予測できる可能性があります。セキュリティに敏感な用途に適した
// 乱数については、[crypto/rand] パッケージを参照してください。
package rand
